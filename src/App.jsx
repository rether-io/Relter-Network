          ...
          <nav className="top-nav fixed w-full z-50 top-0">
            <div className="container mx-auto max-w-5xl rounded-full bg-zinc-900/50 px-6 py-3 flex justify-between items-center">
              ...
              <ul className="menu flex space-x-6">
                <li><a href="#how-it-works" className="text-gray-300 hover:text-white transition-colors duration-200 text-lg">Como Funciona</a></li>
                <li><a href="#benefits" className="text-gray-300 hover:text-white transition-colors duration-200 text-lg">Benefícios</a></li>
                <li><a href="#use-cases" className="text-gray-300 hover:text-white transition-colors duration-200 text-lg">Casos de Uso</a></li>
                <li><a href="#features" className="text-gray-300 hover:text-white transition-colors duration-200 text-lg">Recursos</a></li>
